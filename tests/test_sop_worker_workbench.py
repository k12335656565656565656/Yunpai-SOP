...
class SopWorkerWorkbenchTests(unittest.TestCase):
    ...
    def test_worker_page_exposes_simple_natural_language_flow(self) -> None:
        ...
        self.assertIn("PREVIEW_IMAGE_TIMEOUT_MS=30000", simple_html)
        self.assertIn("data-page-retry", simple_html)
        self.assertIn("requestPreviewImage", simple_html)
        ...
        self.assertIn("pageEditMethodLayoutV4", simple_html)
        self.assertIn("pageEditRegionsForPageV4", simple_html)
        self.assertIn("pageEditUsesV4", simple_html)
        self.assertIn("label:'异常处理'", simple_html)
        self.assertIn("pageEditParameters", simple_html)
