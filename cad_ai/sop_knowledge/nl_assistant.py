...
class NaturalLanguageSopAssistant:
    ...
    def _llm_preview(
        ...
        *,
        ...
        # Keep conversational edits on the same provider adapter as project creation.
        # This respects OPENAI_WIRE_API=responses and avoids silently calling the
        # legacy Chat Completions endpoint when the configured provider uses Responses.
